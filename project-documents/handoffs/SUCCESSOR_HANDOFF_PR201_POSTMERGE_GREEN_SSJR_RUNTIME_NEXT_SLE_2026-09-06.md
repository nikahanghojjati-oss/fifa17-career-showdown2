...
Billing must remain permanently OFF. Firebase must remain Spark. Never link Cloud Billing, enable Blaze, add payment methods, use purchased credits, Cloud Run, Cloud Functions or billing-required services.
