# START NEXT SESSION — v1.4.5 — PR #130 Stage 4 Source Seal → Provider Proof
...
Production remains `v1.6.0 / 1.6.0-r1`, Stage 3 Registered Devices / Private Pairing production-proven. Stage 4 candidate is `v1.7.0 / 1.7.0-r1`, NOT production-proven.

PR #130 branch: `agent/v1.7.0-connected-rivalry-state`.
Immutable validated Stage 4 source seal: `7336adda832322bbd93e8c16f3de0e4bbf5273c1`.
Reviewed Stage 4 `firestore.spark.rules` blob at that seal: `ecc8ccb2ab50f0f7057ab3170eb080ad9e36025f`.
On the exact source seal: all 14 permanent workflow families green, zero submitted reviews, zero inline review threads, mergeable true.
...
App Check enforcement remains OFF. Firebase Spark / zero billing remains mandatory. Firestore persistent cache remains disabled/memory-only. Google Auth remains popup-only `browserSessionPersistence` with no extra scopes. No Blaze, Cloud Run, Cloud Functions or Firebase Storage. Canonical local storage and Candidate C destructive-Apply locks remain unchanged. Stage 5 Remote Joining sessions remain blocked.

Remote Joining readiness remains `69/100`; source, CI, emulator and documentation work do not move RJR-1.
