...
8. verify production remains source/runtime `v1.8.1 / 1.8.1-r5` and the deployed acceptance URL actually renders `PROBE ENUMERATION DENIAL` with its acceptance-only modules available rather than the app shell or a script-less document;
