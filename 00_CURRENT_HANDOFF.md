...
Production remains the previously proven `v1.9.1 / 1.9.1-r2`; previous whole-shell recovery remains `1.9.1-r1`. Historical PR #198 published the fixed RJR-1 COMPLETE 100/100 evidence after the final stable-release acceptance; publication itself earned zero RJR credit. The consumed physical acceptance used a Chromebook on Home WiFi and an iPhone on cellular across two independent networks and remains historical evidence only. PR #201 final exact head `2c99e0746d6a3c5df946aa96f2c010da208bf70f`, tree `87ddbde2550facccdfba0ec02a3a625ea81d1a08`, passed all 15 permanent PR workflow families and was expected-head squash merged as main `0cf810f99460bc66d41b4a036d42befb5bb5ef39`.
