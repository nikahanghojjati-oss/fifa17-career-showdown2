...
PR #191 remains OPEN and must not merge until all permanent workflow families are green on one exact reviewed head. Last remote PR head before successor repair: `4a63137b918b3d4b6d3d93916e67b72e85848c39`. Its three failed workflows shared the stale current-authority assertion beginning at `tests/contracts/private-account-auth-stage2b-contracts.cjs:62`. The successor repair now passes the full local contract and browser matrices while explicitly preserving immutable Stage 2B and PR187/RJR89 provenance; it must still be published and prove every exact-head workflow before merge.
