# CURRENT HANDOFF — SSJR-1 SETUP CANDIDATE
...
Use connected GitHub first, verify live state, read `SESSION_BOOTSTRAP.json`, both readiness ledgers, `NEXT_TASK.md` and the active WEC. Expand through `SSJR1_BASELINE_AND_SETUP_FOUNDATION_2026-09-05.md` only as needed.
