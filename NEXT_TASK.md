...
5. Require every current permanent workflow family green on the same exact reviewed PR head and clear objective review state. Then squash merge with expected-head SHA protection under the owner’s standing authorization. The present topology has 15 permanent workflow families, but successor publication discipline is dynamic rather than pinned to that count.
