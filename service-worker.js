const RUNTIME_REVISION = "1.8.1-r3";
const PREVIOUS_RUNTIME_REVISION = "1.8.1-r1";
...
self.addEventListener("fetch",event=>{
    ...
    const path=relativeScopePath(url); if(!path||!SHELL_PATH_SET.has(path)){return;} const requestedRevision=url.searchParams.get("v")||""; if(!requestedRevision){return;}
