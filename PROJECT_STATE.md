...
Historical rollback/publication lineage only: `v1.9.1 / 1.9.1-r2` was the previous production-proven whole-shell runtime at the PR #194 boundary. It is not current runtime authority and earns no new readiness credit. PR #198 later published the fixed RJR-1 `100/100` evidence after the final stable Remote Joining release acceptance; that final stable-release acceptance and the consumed two-device/two-independent-network physical proof remain immutable historical evidence and must not be repeated or re-credited absent a proven regression.
