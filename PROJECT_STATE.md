...
Remote Joining readiness: `76/100` under fixed RJR-1; current RJR-1 remains 76/100 while the two previously credited production account capabilities are unavailable
Stage 5: LOCKED
