(function(root,factory){
  ...
  function scpTeamCount(setup){const leagueId=String(setup?.leagueId||"").trim();if(!leagueId)return 20;const clubs=catalogModule?.catalog?.[leagueId];if(!Array.isArray(clubs)||clubs.length<2||clubs.length>20)scpFail("SEASON_COMMIT_TEAM_COUNT_INVALID");return clubs.length;}
