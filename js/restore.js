(function(){
  ...
  function createCareerModeRestorePlan(analysis,currentRaw,choices={}){
    ...
    // saveLibrary choice: omitted defaults to keep-current (safe); only keep-current | use-backup are legal
    const saveLibraryChoice=Object.prototype.hasOwnProperty.call(choices,"saveLibrary")?choices.saveLibrary:"keep-current";
    ...
    if(saveLibraryChoice!=="keep-current"&&saveLibraryChoice!=="use-backup"){
