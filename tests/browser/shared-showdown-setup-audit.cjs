...
(async () => {
  ...
  try{
    ...
    console.log("PASS two isolated Chromium contexts: real WebCrypto draw/validation, peer-first dual confirmation, exact setup convergence and unchanged canonical local bytes. Candidate protocol only; SSJR credit 0.");
  }finally{
