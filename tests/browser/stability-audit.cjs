...
async function assertStableReleaseIdentity(page, label){
    ...
    assert.equal(footer, "Career Mode Showdown v1.8.0 · Connected Rivalry", `${label} release footer changed after startup settled.`);
    ...
    checkpoint(`${label} stable release identity`, "v1.8.0 · Connected Rivalry · Save Library");
}
