...
assert.match(state,/RJR-1[\s\S]{0,260}79\/100/i,"Live PROJECT_STATE must keep the current owner-proven reconciliation readiness score.");
...
process.stdout.write("PASS Private Account/Auth Stage 2C policy with historical Stage 2D transition preserved and current reconciliation authority explicit\n");
