...
assert.ok(html.includes(`<footer>Career Mode Showdown<br>v${appVersion}</footer>`), 'Footer release identity must track APP_VERSION without advertising an implementation mode.');
