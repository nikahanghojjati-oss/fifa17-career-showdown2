...
assert.ok(html.includes(`v${appVersion} · Stable`) || html.includes(`v${appVersion} · Product Deepening`) || html.includes(`v${appVersion} · Private Connected Account Foundation`), 'Footer release identity must track APP_VERSION.');
