...
assert.match(state,/CURRENT OVERRIDE — v1\.8\.1-r3 STAGE 4 RECONCILIATION PRODUCTION-PROVEN/i,"Current PROJECT_STATE must identify the production-proven reconciliation authority rather than revive Stage 2A.");
