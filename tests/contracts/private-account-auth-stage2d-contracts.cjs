...
assert.match(next,/STAGE 5 REMAINS LOCKED|Stage 5 host\/join\/session orchestration remains locked/i,"Live PR #163 authority must keep Stage 5 locked until the explicit remaining gates close.");
...
process.stdout.write("PASS Private Account/Auth Stage 2D preflight with historical selection authority preserved and current PR #163 publication authority explicit\n");
