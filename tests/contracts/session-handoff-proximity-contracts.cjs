...
(async () => {
  ...
  assert.ok(score(add(fresh(), { unresolvedDebugLoops: 2 })) >= 80);
  ...
  process.stdout.write("PASS Session Handoff Proximity v2: zero reset, observable weights, monotonicity, risk floors, bands, WEC stop priority, verified package and HTR separation.\n");
