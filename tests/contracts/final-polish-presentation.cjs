...
const visualCss = fs.readFileSync('css/visual-fidelity-r3.css', 'utf8');
...
assert.ok(visualCss.includes('R9 SLICE 6 — SEASON SUMMARY'), 'R9 Season Summary presentation layer is missing.');
assert.ok(visualCss.includes('R9 SLICE 10 — GLOBAL RUNTIME NOTICE'), 'R9 global runtime notice presentation layer is missing.');
