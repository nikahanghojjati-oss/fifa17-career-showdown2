...
assert.ok(app.includes("STARTUP_SPLASH_REDUCED_MS = 220"));
...
process.stdout.write(
    `PASS  Dynamic static release contracts v${appVersion} / ${revision}: scoring, navigation, 98-club identity, startup shape, budgets ${codeBytes}/${gzipBytes}, storage/route authority, Candidate C lazy loading and historical release protection.\n`
);
