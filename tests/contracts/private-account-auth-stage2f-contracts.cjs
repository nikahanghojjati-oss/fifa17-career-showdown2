...
(async () => {
  ...
  process.stdout.write("PASS Private Account/Auth Stage 2F trusted request authentication with historical Stage 2E/2F transition preserved and current PR #163 authority explicit\n");
})().catch(error => {
