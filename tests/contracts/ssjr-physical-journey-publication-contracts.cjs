...
assert.match(validator,/1\.9\.1-r46/);
assert.match(guide,/Physical Journey Production Acceptance — r46/);
...
console.log("PASS r46 Physical Journey acceptance tooling is coherently versioned, offline-retained, query-gated and permanently routed into POS20 without changing provider authority");
