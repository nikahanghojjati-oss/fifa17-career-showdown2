...
assert.match(archivedNext, /Stage 2B[\s\S]{0,260}DONE \/ MERGED \/ PROVEN/i,"Archived authority must retain Stage 2B completion provenance.");
assert.match(archivedNext, /Completed Handoff Proximity governance synchronization[\s\S]{0,520}PR #86[\s\S]{0,520}DONE \/ MERGED \/ PROTECTED/i,"Archived authority must retain PR #86 governance completion provenance.");
assert.match(archivedNext, /Current authorized prerequisite candidate[\s\S]{0,520}Stage 2D/i,"Archived authority must retain the historical Stage 2D authorization transition.");
assert.match(archivedNext, /Completed post-PR #86 authority reconciliation[\s\S]{0,520}PR #87[\s\S]{0,520}DONE \/ MERGED \/ PROVEN/i,"Archived authority must retain PR #87 reconciliation provenance.");
assert.match(next, /Stages 2A through 2I[\s\S]{0,120}DONE \/ MERGED \/ PROVEN/i,"Current NEXT_TASK must keep completed Stage 2A-2I status live while the gateway prerequisite advances.");
...
process.stdout.write("PASS Private Account/Auth Stage 2B completed provider lifecycle, revocation and Stage 2D historical transition contracts\n");