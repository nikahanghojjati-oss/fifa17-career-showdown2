...
assert.ok(
    projectState.includes(`**Application version:** v${appVersion}`) || projectState.includes(`**Release candidate:** v${appVersion}`),
...
assert.ok(
    readme.includes(`**Application version:** v${appVersion}`) || readme.includes(`**Release candidate:** v${appVersion}`),
