...
assert.match(nextTask,/^# CURRENT OVERRIDE — v1\.8\.1-r5 SUSTAINED MUTATION-FREQUENCY HARDENING — RJR84 — PR #163 PUBLICATION/im,"Live NEXT_TASK must identify the current PR #163 publication authority rather than revive PR #125, the r3 recovery incident, or an older reconciliation heading.");
...
process.stdout.write("PASS trusted connected data account export boundary: private explicit portability, exact entitlement/read scope, peer-identity minimization, secret exclusion, dormant trusted-export isolation and unchanged IAM/browser-write locks remain protected under current PR #163 authority.\n");
