...
If PR #159 is still open after the fresh WEC owns and assesses its status, perform read-only validation of its immutable WEC-100 head, require the standing publication gates to remain clean, publish it under standing owner authorization, and verify resulting live `main` plus post-merge/deployment state. Do not begin token-lifecycle product work while PR #159 remains unpublished or its post-merge publication state is unverified.
