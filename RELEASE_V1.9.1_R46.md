...
No Firestore Rules, session authority, pairing, scoring formulas, canonical storage writes or billing configuration change. Private Remote Joining, connected-account identity and exact ACTIVE-session authority remain unchanged. Firebase remains Spark-only with billing permanently OFF. App Check enforcement remains OFF.
