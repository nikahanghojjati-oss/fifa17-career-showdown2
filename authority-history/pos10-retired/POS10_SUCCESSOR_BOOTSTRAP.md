...
Base main observed before mutation: `831a13ee93ac1b279c1f7c0985c1c5111922829f`

## Atomic work unit
Deliver POS10 as the sole active project operating system. POS10 absorbs all still-valid source-first authority, exact risk selection, recovery/checkpoint, single-promotion publication, fail-closed validation, permanent product locks, and successor-continuity behavior. No active startup, command, workflow, status protocol, or machine authority may depend on an older POS generation.

## Mandatory response protocol
Every finished developer response ends with exactly one operational line: `Decision: CONTINUE` or `Decision: TRANSITION`.

The decision is state-based. Never infer hidden ChatGPT context/session/five-hour/weekly usage from account plan, message count, tool-call count, elapsed time, or guessed remaining capacity.
