...
function buildHandoffPrompt(state, assessment){
    return [
        ...
        "4. Run npm run work:continuity:validate and npm run work:assess. Replace the prior environment record with a new environment ID and fresh observable signals before substantial work.",
        "5. Reconstruct the exact newest production boundary. Do not trust this prompt over current source.",
        "",
