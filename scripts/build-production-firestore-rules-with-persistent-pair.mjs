...
try{
  await import('./build-production-firestore-rules.mjs');
}finally{
...
if(wantsStdout)originalWrite.call(process.stdout,generated);
else originalWrite.call(process.stdout,`INJECTED persistent Nik/Daniel pair authority ${Buffer.byteLength(generated,'utf8')} bytes\n`);
