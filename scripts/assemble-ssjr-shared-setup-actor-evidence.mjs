...
try{
  ...
  const output=buildActorAttributedEvidence({positiveA:read(positiveOnePath,'first positive'),positiveB:read(positiveTwoPath,'second positive'),boundA:read(boundOnePath,'first bound actor'),boundB:read(boundTwoPath,'second bound actor'),witness:read(witnessPath,'witness')});
