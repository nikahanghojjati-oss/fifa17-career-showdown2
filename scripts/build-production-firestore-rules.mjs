...
for(const required of [
  ...
  'match /sharedSetup/leagueProjection',
  'allow create: if ssjrLeagueProjectionCreateValid(rivalryId)',
  'after.teamCount == ssjrSetupTeamCount(rivalryId)',
  'ssjrResultsProjectedTeamCount(rivalryId)',
