...
if(base.includes('match /sharedSetup/authoritative')||base.includes('ssjrValidCreateLedger')||base.includes('match /careerStart/authoritative')||base.includes('ssjrCareerValidCreate')||base.includes('match /transferChallenges/{transferId}')||base.includes('ssjrTransferValidCreate')){
